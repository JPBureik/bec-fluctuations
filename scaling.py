...
REL_FLUCT_TARGETS = [0.4,]#[8,15,20]#, 6.1, 8, 15]
ETA = 0.53
UJ_SCALING = 24
...
for uj in [20, 24,]:
    ...
    CTRL_VAL_SHIFT_RANGE = 1#400
        
        
    CTRL_VAL_SHIFTS = np.linspace(-CTRL_VAL_SHIFT_RANGE, CTRL_VAL_SHIFT_RANGE, 3)#100)
    ...
    for idx, rel_fluct_target in enumerate(REL_FLUCT_TARGETS):
        ...
        bec_atom_numbers[rel_fluct_target] = [mom_ps_atom_numbers_sc[ctrl_val_shift][rel_fluct_target][UJ_SCALING].mean() / ETA for ctrl_val_shift in CTRL_VAL_SHIFTS]
